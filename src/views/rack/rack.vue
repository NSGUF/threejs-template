            ...
            <div id="container">
                ...
                <div id="serverInfo"
                    ...
                    <div class="center-cabinet__content-dialog-wrap-service-layer ellipsis">
                        <span>test</span>
                        <span v-title
                              class="center-cabinet__content-dialog-wrap-service-name">{{
...
import { RACK_OPERATE_TYPE, SERVICE_TYPE, SERVICE_TYPE_TEXT } from './const';
import { initRack, removeRack, updateRack } from './candy.js';

interface ServerInfo {
    sf_host_id: number,
    sf_host_status: string,
    sf_host_name: string,
}
