import{V as i,_ as u,r as y,c as E,b as F,w as D,d as s,a as d,o as m,e as n}from"./app.62f1b0cb.js";const{defineComponent:B}=i,A=B({name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:a,createVNode:l,openBlock:p,createElementBlock:o}=i,e={style:{height:"600px",width:"680px"}};function t(r,R){const C=a("rack");return p(),o("div",e,[l(C)])}return{render:t,...{}}}()}}),f=JSON.parse('{"title":"lottie","description":"","frontmatter":{},"headers":[],"relativePath":"components/lottie.md","lastUpdated":1691138245000}'),_=s("h1",{id:"lottie",tabindex:"-1"},"lottie",-1),h=s("blockquote",null,[s("p",null,"\u6548\u679C\u5C55\u793A\u4E3A\u4E0B\u9762demo\u4E2D\uFF0C\u670D\u52A1\u5668\u5E95\u90E8\u8F6C\u52A8")],-1),g=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"}),n(`
