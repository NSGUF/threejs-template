import{V as D,_ as u,r as y,c as d,b as F,w as i,d as s,a as E,o as m,e as n}from"./app.2a831956.js";const{defineComponent:h}=D,_=h({name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:a,createVNode:l,openBlock:o,createElementBlock:p}=D,e={style:{height:"600px",width:"900px"}};function c(r,x){const C=a("rack-list");return o(),p("div",e,[l(C)])}return{render:c,...{}}}()}}),b=JSON.parse('{"title":"\u8C03\u8BD5\u7EC4\u4EF6","description":"","frontmatter":{},"headers":[],"relativePath":"components/debug-tools.md","lastUpdated":1692236508000}'),B=s("h1",{id:"\u8C03\u8BD5\u7EC4\u4EF6",tabindex:"-1"},"\u8C03\u8BD5\u7EC4\u4EF6",-1),v=s("blockquote",null,[s("p",null,"\u6548\u679C\u5C55\u793A\u4E3A\u4E0B\u9762demo\u4E2D\uFF0C\u53F3\u4E0A\u89D2\u7684\u7F16\u8F91\u533A\u57DF")],-1),g=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#C9D1D9"}},"<"),s("span",{style:{color:"#7EE787"}},"template"),s("span",{style:{color:"#C9D1D9"}},">")]),n(`
