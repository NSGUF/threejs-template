import{_ as s,c as n,o as a,a as p}from"./app.2a831956.js";const d=JSON.parse('{"title":"\u89C4\u8303","description":"","frontmatter":{},"headers":[],"relativePath":"specification/index.md","lastUpdated":1692236508000}'),l={name:"specification/index.md"},o=p(`<h1 id="\u89C4\u8303" tabindex="-1">\u89C4\u8303</h1><h2 id="\u9632\u6B62\u5185\u5B58\u6CC4\u6F0F" tabindex="-1">\u9632\u6B62\u5185\u5B58\u6CC4\u6F0F</h2><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki vp-code-dark"><code><span class="line"><span style="color:#8B949E;">// 1. \u6E05\u7A7A\u573A\u666F</span></span>
